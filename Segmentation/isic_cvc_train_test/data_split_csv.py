...
def pre_csv(data_path,frac):
    ...
    df.to_csv('src/CVC_ClinicDB/test_train_data.csv',index=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default=r'/home/cqut/Data/medical_seg_data/CVC_ClinicDB/images', help='the path of images') # issue 16
    parser.add_argument('--size', type=float, default=0.9, help='the size of your train set')
    args = parser.parse_args()
    os.makedirs('src/CVC_ClinicDB',exist_ok=True)
