...
from my_trainer import trainer_synapse
...
parser.add_argument("--output_dir", type=str, default="./save_models/other_attention/bra", help="output dir")
...
parser.add_argument(
    "--module", help="The module that you want to load as the network, e.g. swin_networks.DAEFormer.DAEFormer"
)
