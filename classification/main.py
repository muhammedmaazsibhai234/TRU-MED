...
def get_args_parser():
    parser = argparse.ArgumentParser('MEDFORMER training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=90, type=int)
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='medformer_base', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='data/ISIC2018', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='ISIC2018', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19',
                                                                   'Retino', 'ISIC2018', 'ColonPath', 'BUSI', 'BT'],
                        type=str, help='Image Net dataset path')
    parser.add_argument('--inat-category', default='name',
                        choices=['kingdom', 'phylum', 'class', 'order', 'supercategory', 'family', 'genus', 'name'],
                        type=str, help='semantic granularity')
    parser.add_argument('--output_dir', default='/classification/output',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/classification/output',
                        help='path where to save, empty for no saving')
...
def main(args):
    ...
    dataset_train, args.nb_classes = build_dataset(is_train=True, is_validation=False, args=args)
    dataset_val, _ = build_dataset(is_train=False, is_validation=True, args=args)
